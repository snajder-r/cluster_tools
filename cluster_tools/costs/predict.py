...
class PredictBase(luigi.Task):
    ...
    output_labels_key = luigi.Parameter()
    dependency = luigi.TaskParameter()
    edge_classes = luigi.ListParameter()
    ...
    def run_impl(self):
        ...
        with vu.file_reader(self.output_path) as f:
            ...
            f.require_dataset(self.output_labels_key, shape=(n_edges,), compression='gzip',
        ...
        config.update({'rf_path': self.rf_path,
                       ...
                       'chunk_size': chunk_size, 'n_edges': n_edges, 'edge_classes': self.edge_classes})
...
def predict(job_id, config_path):
    ...
    output_labels_key = config['output_labels_key']
